/**
 * Created by Adrian on 07/10/2015.
 */
import java.util.*;
...
public class Oblig2Test
{
    ...
    public static int oppgave9()
    {
        ...
        catch (Exception e)
        {
            if (!(e instanceof NullPointerException))
            {
                System.out.println("Oppgave 9g: Det kastes feil type unntak!");
                antallFeil++;
            }
        }
        ...
        {
            System.out.println
                    ("Oppgave 9h: forEach virker ikke som den skal for tom liste!");
            antallFeil++;
        }
        ...
        {
            System.out.println
                    ("Oppgave 9j: forEachRemaining virker ikke som den skal!");
            antallFeil++;
        }
